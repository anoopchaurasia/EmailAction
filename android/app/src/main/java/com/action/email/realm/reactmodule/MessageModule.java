...
public class MessageModule extends ReactContextBaseJavaModule {
    ...
    @ReactMethod
    public void create(ReadableMap messageMap) {
    ...
    @ReactMethod
    public void update(ReadableMap messageMap) {
        Message message = Message.fromMap(messageMap);
    ...
    @ReactMethod
    public void getByDomain(String domain, int page, int pageSize, Promise promise) {
    ...
    @ReactMethod
    public void fetchMessageIdBySenders(ReadableArray senders, Promise promise) {
        List<String> list = new ArrayList<>();
        for (int i = 0; i < senders.size(); i++) list.add(senders.getString(i));
    ...
    @ReactMethod
    public void getLatestMessages(int page, int pageSize, Promise promise) {
    ...
    @ReactMethod
    public void updateAttachmentById(ReadableMap attachmentMap) {
//        Attachment attachment = Attachment.fromMap(attachmentMap);
//        MessageService.updateAttachmentById(attachment);
    }

    @ReactMethod
    public void checkMessageIds(ReadableArray messageIds, Promise promise) {
        List<String> ids = new ArrayList<>();
        for (int i = 0; i < messageIds.size(); i++) ids.add(messageIds.getString(i));
